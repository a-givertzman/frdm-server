...
impl<'a> GaussianBlur<'a> {
    ...
    #[allow(unused)]
    pub fn new(kernel: &[i32; 2], ctx: impl Eval<&'a Mat, Result<Mat, Error>> + 'static) -> Self {
        Self { 
            kernel: kernel.into(),
            sigma: vec![0.0, 0.0],
...
//
//
impl<'a> Eval<&'a Mat, Result<Mat, Error>> for GaussianBlur<'a> {
